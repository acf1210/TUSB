...
1. Baixe o APK mais recente em [Releases](../../releases), arquivo `TUSB-v1.0.5.apk` ou mais novo.
...
1. Download the latest APK from [Releases](../../releases), file `TUSB-v1.0.5.apk` or newer.
...
1. Descarga el APK más reciente en [Releases](../../releases), archivo `TUSB-v1.0.5.apk` o más nuevo.
